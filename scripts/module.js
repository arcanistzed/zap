...
inspector.style.border = "2px solid yellow";
inspector.style.background =
	"repeating-linear-gradient(45deg, transparent, transparent 0.5rem, rgba(255, 255, 0, 0.5) 0.5rem, rgba(255, 255, 0, 0.5) 1rem)";
